...
public class EarthquakeCityMap extends PApplet {
	...
	private void printQuakes() 
	{
		...
		for(Marker country : countryMarkers)
		{
			...
			if(noofquakes>0)
			System.out.println(country.getProperty("name")+":"+noofquakes);
		}
		int noofOceanquakes=0;
		for(Marker quake: quakeMarkers)
		{
		...
		System.out.println("OCEAN QUAKES"+":"+noofOceanquakes);
